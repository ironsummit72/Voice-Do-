...
public class Adapter extends RecyclerView.Adapter<Adapter.PlaceHolder> {
    ...
    public void onBindViewHolder(@NonNull final Adapter.PlaceHolder holder, final int position) {
     ...
     //   int databaseid=todolist.get(position).uid;
        ...
        final String path=todolist.get(position).path.toString();
        String checkuncheck=todolist.get(position).booleancheck.toString();
...
holder.checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        else if(!isChecked){    holder.todotxtview.setPaintFlags(holder.todotxtview .getPaintFlags() & (~Paint.STRIKE_THRU_TEXT_FLAG));
...
dialogplayread(path,holder.todotxtview.getText().toString());
    ...
    public void dialogplayread(final String url, final String title)
    {
        ...
        play=(Button)playreaddialog.findViewById(R.id.play);
        read=(Button)playreaddialog.findViewById(R.id.read);
        playreaddialog.show();
    ...
    public void playdialog(String url)
    {
        ...
        progressseek=(SeekBar) mediadialog.findViewById(R.id.seekBarprogress);
        dplay=(Button)mediadialog.findViewById(R.id.playpause);
        current=(TextView)mediadialog.findViewById(R.id.currentd);
        total=(TextView)mediadialog.findViewById(R.id.totald);
    ...
    public void readdialog(String s)
    {
        ...
        reads=(TextView)readdialog.findViewById(R.id.reads);
    ...
    public class PlaceHolder extends RecyclerView.ViewHolder {
        ...
        public PlaceHolder(@NonNull View itemView) {
            ...
            todotxtview=(TextView)itemView.findViewById(R.id.todotxtview);
